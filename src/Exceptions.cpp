/**
 * @file Exceptions.cpp
 * @brief Implements the exception types and error translators used by the IRC server.
 * @details Implements the `PersonalizedException` base class and several derived
